...
\begin{frame}[shrink=18]{Las Variables, Una a Una}
  ...
  {\scriptsize\color{textMuted}\itshape
   ...
   se va a hablar de la variable y no del problema.\\[4pt]
   {\color{arcaDark}Dos de ellas nombran el \textbf{choke}. Qué es exactamente
   esa pieza, y por qué al taparse una presión sube y una temperatura baja,
   es lo primero que vamos a ver.}}
\end{frame}

\begin{frame}[shrink=18]{Acotar el Problema (Regla de la Casa)}
  \vspace{-4pt}
  {\small\color{arcaDark}\bfseries
...
\begin{frame}[shrink=6]{Un Pozo que Nadie Puede Ir a Mirar}
  \vspace{-6pt}
  \begin{center}
    \includegraphics[height=0.48\textheight]{fig_pozo.png}
  \end{center}
  \vspace{-4pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=16]{¿Qué es un Choke? La Pieza de Toda la Clase}
  \vspace{-4pt}
  {\small\color{arcaDark}\bfseries
...
\begin{frame}[shrink=6]{Lo que le Hace el Choke al Fluido}
  \vspace{-8pt}
  \begin{center}
    \includegraphics[height=0.58\textheight]{fig_choke.png}
  \end{center}
  \vspace{-4pt}
...
\begin{frame}[shrink=16]{Por Qué se Enfría: el Efecto Joule--Thomson}
  \vspace{-4pt}
  {\small\color{arcaDark}\bfseries
...
\begin{frame}[shrink=16]{Qué es, Exactamente, una Serie de Tiempo}
  \vspace{-4pt}
  {\small\color{arcaDark}\bfseries
  ...
  \vspace{5pt}
  \begin{center}
    \includegraphics[height=0.32\textheight]{fig_que_es_serie.png}
  \end{center}
  \vspace{-2pt}
  \begin{columns}[T]
    \begin{column}{0.49\textwidth}
...
\begin{frame}[shrink=6]{La Señal, de Verdad}
  \vspace{-8pt}
  \begin{center}
    \includegraphics[height=0.60\textheight]{fig_senal_cruda.png}
  \end{center}
  \vspace{-6pt}
  {\footnotesize\color{arcaDark}
...
\begin{frame}[shrink=6]{La Alarma, Puesta a Prueba en un Pozo}
  \vspace{-8pt}
  \begin{center}
    \includegraphics[height=0.60\textheight]{fig_alarma.png}
  \end{center}
  \vspace{-4pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=16]{Cómo se Mide «Bien» o «Mal»: Tres Números}
  \vspace{-4pt}
  {\small\color{arcaDark}\bfseries
...
\begin{frame}[shrink=24]{Las Tres Componentes, Una a Una}
  \vspace{-4pt}
  {\small\color{arcaDark}\bfseries
...
\begin{frame}[shrink=22]{Pero Hay un Problema: Cada Pozo Vive en Otro Mundo}
  \vspace{-6pt}
  \begin{center}
...
\begin{frame}[shrink=16]{Lo que Dice la Escalera, Leído Despacio}
  \vspace{-4pt}
  {\scriptsize
...
\begin{frame}[shrink=6]{Cuánto Tarda Cada Uno en Darse Cuenta}
  \vspace{-8pt}
  \begin{center}
    \includegraphics[height=0.66\textheight]{fig_resultado.png}
  \end{center}
  \vspace{-4pt}
  {\footnotesize\color{arcaDark}
...
\begin{frame}[shrink=6]{Las Falsas Alarmas que No lo Eran}
  \vspace{-6pt}
  \begin{center}
    \includegraphics[height=0.54\textheight]{fig_falsas.png}
  \end{center}
  \vspace{-4pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=16]{Su Turno: el Pozo con Dos Sensores \hfill {\normalsize\color{arcaRed}\faClock\hspace{4pt}18 min}}
  \vspace{-4pt}
  \begin{tcolorbox}[colback=arcaGray, colframe=arcaDark, boxrule=0pt, leftrule=3pt,
    arc=3pt, left=8pt, right=8pt, top=5pt, bottom=5pt]
    {\footnotesize\color{arcaDark}\itshape
