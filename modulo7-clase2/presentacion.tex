...
\begin{frame}[shrink=8]{Lo que Aparece: 23 Piedras que No Existen}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.92\textwidth, height=0.46\textheight, keepaspectratio]{fig_certificar.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=8]{El Examen: 10.784 Piedras que Nunca Vio}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.82\textwidth, height=0.47\textheight, keepaspectratio]{fig_ajuste.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=8]{En Qué Se Fija --- y la Lectura Honesta}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.88\textwidth, height=0.44\textheight, keepaspectratio]{fig_importancias.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=5]{Qué Es Gradio (lo Pendiente de la Clase 1)}
  \vspace{4pt}
  {\footnotesize\color{textMuted}
   \textbf{Gradio} convierte una función de Python en una página web con
   controles. Uno le dice \emph{«esta función recibe las medidas y devuelve
   el precio»}, y él arma solo la interfaz: las casillas, el botón, el
   espacio de la respuesta.
   \vspace{6pt}

   No hay que saber nada de páginas web. Y en Colab, con
   \texttt{share=True}, genera un \textbf{link público}: una dirección que el
   comprador abre desde su celular en la mesa de compra, mientras el cuaderno
   de ustedes hace el trabajo por detrás.}
  \vspace{7pt}
  \begin{tcolorbox}[colback=arcaGray, colframe=arcaRed, boxrule=0pt,
    ...
    {\footnotesize\color{textMuted}
     ...
     se desconecta, el link deja de responder. Perfecto para una demo o una
     jornada de trabajo; no es un sistema permanente --- eso se conversa en
     la Clase 3.}
  \end{tcolorbox}
\end{frame}
...
\begin{frame}[shrink=8]{La Prueba que Nadie le Hace a su Propia App}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.94\textwidth, height=0.46\textheight, keepaspectratio]{fig_cero.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=8]{La Banda Sale Gratis: los 100 Árboles No Opinan lo Mismo}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.97\textwidth, height=0.44\textheight, keepaspectratio]{fig_banda.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
