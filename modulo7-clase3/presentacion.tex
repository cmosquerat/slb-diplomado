...
\begin{frame}[shrink=8]{Paso 1 · Lo que Dice el Dato}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.96\textwidth, height=0.44\textheight, keepaspectratio]{fig_t_eda.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=8]{Paso 2 · El Resultado de la Búsqueda}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.80\textwidth, height=0.44\textheight, keepaspectratio]{fig_t_grid.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=8]{Paso 3 · El Examen, en Probabilidades}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.97\textwidth, height=0.42\textheight, keepaspectratio]{fig_t_examen.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=8]{Paso 4 · Qué Mueve la Predicción}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.86\textwidth, height=0.46\textheight, keepaspectratio]{fig_t_shap.png}\end{center}
  \vspace{2pt}
  {\scriptsize\color{textMuted}
...
\begin{frame}[shrink=8]{Paso 4 · El Porqué de UNA Predicción}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.86\textwidth, height=0.42\textheight, keepaspectratio]{fig_t_persona.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=8]{La No Linealidad: la Respuesta, Leída Juntos}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.94\textwidth, height=0.44\textheight, keepaspectratio]{fig_moons.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=8]{MNIST: Donde No Hay Tabla}
  \vspace{-2pt}
  \begin{center}\includegraphics[width=0.92\textwidth, height=0.40\textheight, keepaspectratio]{fig_mnist.png}\end{center}
  \vspace{2pt}
  {\footnotesize\color{textMuted}
...
\begin{frame}[shrink=5]{\faTools\hspace{4pt}Su Reto · La Misma Red, Otra Ropa}
  \vspace{-2pt}
  \begin{tcolorbox}[colback=white, colframe=arcaRed, boxrule=1.4pt,
    arc=3pt, left=8pt, right=8pt, top=4pt, bottom=4pt,
    title={\hspace{-2pt}\faTools\hspace{5pt}SU ENCARGO --- Fashion-MNIST
      (70.000 prendas de ropa, 28×28; la carga viene dada)},
    fonttitle=\scriptsize\bfseries\sffamily, colbacktitle=arcaRed,
    coltitle=white,
    attach boxed title to top left={xshift=8pt, yshift=-7pt},
    boxed title style={arc=2pt, boxrule=0pt, top=1.5pt, bottom=1.5pt,
      left=6pt, right=6pt}]
    {\scriptsize\color{textMuted}
     Repitan el flujo completo de MNIST sobre la ropa: \textbf{armar y
     entrenar}, \textbf{las curvas}, \textbf{los errores a la cara}. El
     cambio de nivel: esta vez \textbf{los prompts los escriben ustedes},
     con la plantilla de la Clase 1.}
  \end{tcolorbox}
  \vspace{3pt}
  {\scriptsize\color{textMuted}
  ...
  \begin{itemize}\setlength{\itemsep}{2pt}
    \item[{\color{arcaRed}\scriptsize\faQuestion}]
      La \textbf{misma arquitectura} que leyó dígitos: ¿rinde igual acá?
      ¿Qué les dice la diferencia sobre \emph{dónde vive la dificultad}?
    \item[{\color{arcaRed}\scriptsize\faQuestion}]
      ¿En qué época empieza \textbf{ahora} el overfitting --- antes o
      después que con los dígitos?
    \item[{\color{arcaRed}\scriptsize\faQuestion}]
      ¿Qué \textbf{prendas se confunden} entre sí? ¿Los confundirían
      también a ustedes? ¿Qué implicaría si esta red etiquetara inventario?
  \end{itemize}}
  \vspace{2pt}
  {\scriptsize\color{arcaDark}\bfseries\itshape
   En clase si alcanza; si no, para la casa --- el mejor calentamiento para
   la entrega del jueves. Sin solución escrita, como siempre.}
\end{frame}
...
- detecta objetos en la imagen de prueba (la URL
  está en la celda dada del cuaderno)
